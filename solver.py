...
def search24x35(UD_flip, RL_flip, FB_flip, UD_twist, RL_twist, FB_twist, UD_slice_sorted, \
    ...
    if solfound:
        return
    if togo == 0:
        if corners == 0:  # slicesorted should all be 0, ANALYSIEREN was evtl noch nicht stimmt
            solfound = True
        return
        ...
        for m in en.Move:
            ...
            sofar.append(m)
            # cputime += (time.perf_counter() - timex)
            search24x35(UD_flip1, RL_flip1, FB_flip1, UD_twist1, RL_twist1, FB_twist1, UD_slice_sorted1,
...
def solve24x35(cubestring):
    ...
    while not solfound:
        ...
        nodecount = 0
        # cputime = 0
        search24x35(coc.UD_flip, coc.RL_flip, coc.FB_flip, coc.UD_twist, coc.RL_twist, coc.FB_twist,
